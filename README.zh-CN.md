...
### 🌍 完整双语支持
- **164 个 i18n 键值**覆盖全部 UI 界面和后端逻辑
- 首次启动语言选择（中文 / English）
- 桥接日记和所有系统消息现已本地化

### 🛡️ 体验加固
- 修复引导绕过问题 — 语言选择现为进入主应用的必要步骤
- 流式语音中断 — 使用 `AbortController` 随时干净地停止 TTS
- 设置中新增恢复出厂 — 一键清除所有本地数据，重新开始
...
- ⚙️ **首次引导** — 开箱即有 onboarding 流程，选择语言、填入 API key 和偏好后即可使用
- 🌍 **完整国际化** — 随时在中英文之间切换
- 🔄 **恢复出厂** — 在设置中一键清除所有本地数据，重新开始
...
首次启动会进入引导页面，选择语言、填入 API key 和昵称即可开始。
...
<p align="center">
  <img src="docs/screenshots/chat.jpg" alt="和 Vela 聊天" width="80%">
  <br><em>沉浸式对话 — 她的表情会跟着情绪变化，不是罐头回复</em>
</p>

<p align="center">
  <img src="docs/screenshots/onboarding.jpg" alt="初次相遇" width="80%">
  <br><em>第一次见面 — 好奇、微羞、一切才刚刚开始</em>
</p>

<p align="center">
  <img src="docs/screenshots/emotions.jpg" alt="情绪表现" width="80%">
  <br><em>12 种情绪预设 — 开心、害羞、傲娇、认真……她不是只会笑的 NPC</em>
</p>
