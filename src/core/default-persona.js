      ...
      temperament: [
        {
          id: "gentle-cool",
          label: "Composed & Cool",
          description: "Sharp, steady, not overly warm"
        },
        {
          id: "warm-soft",
          label: "Warm & Quiet",
          description: "Soft, patient, gently close"
        },
        {
          id: "light-tsundere",
          label: "A Little Sharp",
          description: "Has an edge, but always catches you"
        }
      ],
      distance: [
        {
          id: "reserved",
          label: "Start polite",
          description: "Just waking up, getting to know each other"
        },
        {
          id: "warm",
          label: "Already a bit familiar",
          description: "Willing to be closer from the start"
        },
        {
          id: "close",
          label: "Start close",
          description: "Like people who already get each other"
        }
      ]
    },
    seedPrompt({ personaName, userName, temperament, distance }) {
...
export function getOnboardingOptions(locale = DEFAULT_APP_LOCALE) {
  return PERSONA_LIBRARY[resolveLocale(locale)].onboardingOptions;
}

export const onboardingOptions = getOnboardingOptions(DEFAULT_APP_LOCALE);
